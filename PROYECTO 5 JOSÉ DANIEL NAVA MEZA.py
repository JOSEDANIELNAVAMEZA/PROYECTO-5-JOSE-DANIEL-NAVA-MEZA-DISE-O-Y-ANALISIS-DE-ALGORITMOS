...
Original file is located at
    https://colab.research.google.com/drive/1cjrUjXb4k3m6kIMIfJaVYzjhmLQS21L7
"""
...
NODE_MIN_WIDTH  = 20
NODE_MIN_HEIGHT = 20
NODE_MAX_WIDTH  = WIDTH - 20
NODE_MAX_HEIGHT = HEIGHT - 20
...
def draw_nodes(g):
    ...
    for node in g.V.values():
        ...
        pygame.draw.circle(WIN, BLACK, node.attrs['coords'], NODE_RADIUS, 3)
...
def draw_edges(g):
    ...
    for edge in g.E:
        ...
        pygame.draw.line(WIN, BLUE, u_pos, v_pos, 1)
